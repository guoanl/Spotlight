...
const About = ()=>{
    return(
        ...
        <p className="mb-3 leading-8">Hey! My name is James, I was graduated from the <a href="http://www.utas.edu.au" className="ltrEffect">University of Tasmania</a>, majoring in <a href="https://www.utas.edu.au/courses/cse/courses/k7i-master-of-information-technology-and-systems?year=2023" className="ltrEffect">Information Technology and Systems.</a></p>
